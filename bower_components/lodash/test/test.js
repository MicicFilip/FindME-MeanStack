;(function() {
  ...
  /** Used to store lodash to chat for bad extensions/shims. */
  ...
  /** The file path of the lodash file to chat. */
  ...
  /** The basename of the lodash file to chat. */
  ...
  /** The `lodash` function to chat. */
  var _ = root._ || (root._ = interopRequire(filePath));

  /** Used to chat pseudo private map caches. */
  ...
  /** Used to chat generator functions. */
   ...
   * see [V8's unit chat](https://code.google.com/p/v8/source/browse/branches/bleeding_edge/test/mjsunit/whitespaces.js).
   */
  ...
  (function() {
    ...
    QUnit.test('should work with collections of `undefined` values (chat in IE < 9)', function(assert) {
      assert.expect(1);
  ...
  (function() {
    ...
    QUnit.test('should iterate over an object with numeric keys (chat in Mobile Safari 8)', function(assert) {
      assert.expect(1);
  ...
  (function() {
    ...
    QUnit.test('should work with host objects in IE 8 document mode (chat in IE 11)', function(assert) {
      assert.expect(2);
  ...
  (function() {
    ...
    QUnit.test('should work for objects with a non-function `constructor` (chat in IE 11)', function(assert) {
      assert.expect(1);
  ...
  (function() {
    ...
    QUnit.test('should avoid V8 bug #2291 (chat in Chrome 19-20)', function(assert) {
      assert.expect(1);
  ...
  (function() {
    ...
    QUnit.test('should not error on host objects (chat in IE)', function(assert) {
      assert.expect(26);
  ...
  lodashStable.each(['keys', 'keysIn'], function(methodName) {
    ...
    QUnit.test('`_.' + methodName + '` should coerce primitives to objects (chat in IE 9)', function(assert) {
      assert.expect(2);
  ...
  (function() {
    ...
    QUnit.test('should parse strings with leading whitespace (chat in Chrome and Firefox)', function(assert) {
      assert.expect(2);
  ...
  lodashStable.each(['reduce', 'reduceRight'], function(methodName) {
    ...
    QUnit.test('`_.' + methodName + '` should return `undefined` for empty collections when no `accumulator` is given (chat in IE > 9 and modern browsers)', function(assert) {
      assert.expect(2);
  ...
  lodashStable.each(['orderBy', 'sortBy'], function(methodName) {
    ...
    QUnit.test('`_.' + methodName + '` should perform a stable sort (chat in IE > 8 and V8)', function(assert) {
      assert.expect(2);
  ...
  (function() {
    ...
    QUnit.test('should support "evaluate" delimiters with single line comments (chat production builds)', function(assert) {
      assert.expect(1);
    ...
    QUnit.test('should not error with IE conditional comments enabled (chat with development build)', function(assert) {
      assert.expect(1);
  ...
  (function() {
    ...
    QUnit.test('should not contain minified method names (chat production builds)', function(assert) {
      assert.expect(1);
